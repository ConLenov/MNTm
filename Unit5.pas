...
with MemStat do begin
  physmemload.Caption :=Format('%0.3f ',[(dwTotalPhys-dwAvailPhys) div 1024 /1024])+'提';
  physmemall.Caption := Format('%0.3f ',[dwTotalPhys div 1024 / 1024])+'提';
  physmemava.Caption := Format('%0.3f ',[dwAvailPhys div 1024 / 1024])+'提';
  virtmemload.Caption:= Format('%0.3f ',[(dwTotalPageFile-dwAvailPageFile) div 1024 /1024])+'/';
  virtmemall.Caption := Format('%0.3f ',[dwTotalPageFile div 1024 / 1024])+'提';
end;
end;
